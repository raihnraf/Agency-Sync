...
class ShopwareSyncTriggerTest extends TestCase
{
    public function test_post_sync_shopware_dispatches_job()
    {
    ...
    public function test_endpoint_validates_tenant_platform_type_is_shopware()
    {
        $this->assertTrue(true, 'Test stub - implement after SyncController created');
    }
}
