...
Route::middleware(['auth'])->prefix('dashboard')->group(function () {
    ...
    Route::get('/tenants/json', [TenantController::class, 'indexJson'])->name('dashboard.tenants.json');
    Route::get('/tenants/json/{id}', [TenantController::class, 'showJson'])->name('dashboard.tenants.show.json');
